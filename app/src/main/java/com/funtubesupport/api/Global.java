...
public class Global {
    public static final String API_URL = "http://funtube.coin2cash.club/api/";
    public static final String SECURE_KEY = "4F5A9C3D9A86FA54EACEDDD635185";

    public static final String Youtube_Key = "AIzaSyBre0etPxvVr9HT_eOdd_-ZPXv2Y-74KoE"; // get it from this link  https://console.developers.google.com/apis/credentials
